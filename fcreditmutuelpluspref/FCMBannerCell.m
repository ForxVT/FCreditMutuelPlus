#import "FCMBannerCell.h"
#import "UIImage+CircleMask.h"

@implementation FCMBannerCell
	- (instancetype)initWithSpecifier:(PSSpecifier *)specifier {
		self = [self initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"fcmHeaderCell" specifier:specifier];

		if (self) {
			_unmaskedImage = [[UIImage alloc] initWithContentsOfFile:[[NSBundle bundleWithPath:@"/Library/PreferenceBundles/FCreditMutuelPlusPref.bundle"] pathForResource:@"iconlarge" ofType:@"png"]];
